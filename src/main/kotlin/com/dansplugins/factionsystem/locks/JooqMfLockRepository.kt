...
class JooqMfLockRepository(
    ...
    override fun getLockedBlocks(): List<MfLockedBlock> =
        dsl
            ...
            .map { (_, records) ->
                val accessors =
                    records
                        .filter { it[MF_LOCKED_BLOCK_ACCESSOR.PLAYER_ID] != null }
    ...
    private fun upsertAccessor(
        ...
        dsl
            ...
            .onConflict(MF_LOCKED_BLOCK_ACCESSOR.LOCKED_BLOCK_ID, MF_LOCKED_BLOCK_ACCESSOR.PLAYER_ID)
            .doNothing()
            .execute()
        return dsl
            .selectFrom(MF_LOCKED_BLOCK_ACCESSOR)
            .where(MF_LOCKED_BLOCK_ACCESSOR.LOCKED_BLOCK_ID.eq(lockedBlockId.value))
    ...
    private fun MfLockedBlockRecord.toDomain(accessors: List<MfPlayerId> = emptyList()) =
        MfLockedBlock(
