...
class MfFactionRelationshipService(
    ...
    fun getRelationship(relationshipId: MfFactionRelationshipId): MfFactionRelationship? = relationshipsById[relationshipId]
    ...
    fun getRelationships(factionId: MfFactionId): List<MfFactionRelationship> = relationships.filter { it.factionId == factionId }
    ...
    fun delete(id: MfFactionRelationshipId): Result4k<Unit, ServiceFailure> =
        resultFrom {
    ...
    fun getAllies(factionId: MfFactionId): List<MfFactionId> =
        getRelationships(factionId, ALLY)
            .filter { relationship ->
