...
class MfChatService(
            ...
            when (channel) {
                ...
                ALLIES ->
                    (
                        faction.members +
                            relationshipService
                                .getRelationships(faction.id, ALLY)
    ...
    fun getChatChannelMessages(factionId: MfFactionId): List<MfChatChannelMessage> = repo.getChatChannelMessages(factionId)
    ...
    fun getChatChannelMessageCount(factionId: MfFactionId): Int = repo.getChatChannelMessageCount(factionId)
}
