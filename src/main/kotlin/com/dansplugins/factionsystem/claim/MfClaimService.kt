...
class MfClaimService(
    ...
    fun isClaimingBlockedInWorld(world: World): Boolean = isClaimingBlockedInWorld(world.name)
    ...
    fun delete(claim: MfClaimedChunk) =
        resultFrom {
    ...
    fun deleteAllClaims(factionId: MfFactionId) =
        resultFrom {
