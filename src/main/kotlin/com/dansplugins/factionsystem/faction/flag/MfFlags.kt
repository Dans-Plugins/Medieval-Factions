...
class MfFlags(
    ...
    val mustBeOfficerToManageLand = get<Boolean>("mustBeOfficerToManageLand")!!
    val mustBeOfficerToInviteOthers = get<Boolean>("mustBeOfficerToInviteOthers")!!
    ...
    val neutral = get<Boolean>("neutral")!!
