    ...
    override fun onCommand(
        ...
        plugin.server.scheduler.runTaskAsynchronously(
            ...
            Runnable {
                ...
                if (sender.hasPermission("mf.rename") && senderFaction?.id == faction.id &&
                ...
                if (sender.hasPermission("mf.prefix") && senderFaction?.id == faction.id &&
                    role?.hasPermission(faction, plugin.factionPermissions.changePrefix) == true
                ) {
                    sender.spigot().sendMessage(
                ...
                if (sender.hasPermission("mf.desc") && senderFaction?.id == faction.id &&
                    role?.hasPermission(faction, plugin.factionPermissions.changeDescription) == true
                ) {
                    sender.spigot().sendMessage(
