    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        val view = PaginatedView.fromChatComponents(
            ...
            listOf(
                ...
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionGrantIndependence"]).apply { color = SpigotChatColor.GRAY }),
                ...
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionRelationshipAdd"]).apply { color = SpigotChatColor.GRAY }),
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionRelationshipRemove"]).apply { color = SpigotChatColor.GRAY }),
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionRelationshipView"]).apply { color = SpigotChatColor.GRAY }),
                ...
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionRoleSetDefault"]).apply { color = SpigotChatColor.GRAY }),
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionRoleSetPermission"]).apply { color = SpigotChatColor.GRAY }),
                ...
                arrayOf(TextComponent(plugin.language["CommandFactionHelpFactionSetDescription"]).apply { color = SpigotChatColor.GRAY }),
