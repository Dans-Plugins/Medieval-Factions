                                ...
                                if (playerRole.hasPermission(faction, plugin.factionPermissions.modifyRole(targetRole.id)) &&
                                    ...
                                    arrayOf(
                                        ...
                                        when (permissionValue) {
                                            true ->
                                                TextComponent(plugin.language["CommandFactionRoleViewAllow"].bracket()).apply {
                                            ...
                                            false ->
                                                TextComponent(plugin.language["CommandFactionRoleViewDeny"].bracket()).apply {
                                            ...
                                            null ->
                                                TextComponent(plugin.language["CommandFactionRoleViewDefault"].bracket()).apply {
