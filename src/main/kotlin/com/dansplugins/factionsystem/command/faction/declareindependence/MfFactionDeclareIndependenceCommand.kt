            ...
            Runnable {
                ...
                if (!faction.flags[plugin.flags.isNeutral] && !liege.flags[plugin.flags.isNeutral]) {
                    ...
                    factionRelationshipService
                        .save(MfFactionRelationship(factionId = faction.id, targetId = liege.id, type = AT_WAR))
                        .onFailure {
                    ...
                    factionRelationshipService
                        .save(MfFactionRelationship(factionId = liege.id, targetId = faction.id, type = AT_WAR))
                        .onFailure {
                    ...
                    plugin.server.scheduler.runTask(
                        ...
                        Runnable {
                            ...
                            plugin.server.onlinePlayers
                                .filter { onlinePlayer ->
                                    (faction.members + liege.members).none { member ->
