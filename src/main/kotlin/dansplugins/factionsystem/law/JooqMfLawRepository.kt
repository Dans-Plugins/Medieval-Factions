...
import dansplugins.factionsystem.jooq.Tables.MF_LAW
import dansplugins.factionsystem.jooq.tables.records.MfLawRecord
...
class JooqMfLawRepository(
    ...
    private fun MfLawRecord.toDomain() = MfLaw(
        MfLawId(id),
        version,
