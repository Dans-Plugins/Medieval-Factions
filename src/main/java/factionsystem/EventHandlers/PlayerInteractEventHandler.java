...
public class PlayerInteractEventHandler {
    ...
    private void handleLockingBlock(PlayerInteractEvent event, Player player, Block clickedBlock) {
        ...
        if (chunk != null) {
            ...
            // block type check
            if (main.utilities.isDoor(clickedBlock) || main.utilities.isChest(clickedBlock) || main.utilities.isGate(clickedBlock)) {
                ...
                if (main.utilities.isGate(clickedBlock)) {
                ...
                player.sendMessage(ChatColor.RED + "You can only lock chests, doors or gates.");
                return;
            }
