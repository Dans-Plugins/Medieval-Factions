...
The first release version, [v1.7](https://github.com/dmccoystephenson/Medieval-Factions/releases/tag/v1.7), released on SpigotMC in June 2020 looked much different than the plugin does today.
